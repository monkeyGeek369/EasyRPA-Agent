...
class ScriptExeCore:
    ...
    def script_exe_result_push(self,result:FlowTaskExeResDTO,url:str):
        dispatch_task_core.robot_log_report_handler(log_type=SysLogTypeEnum.INFO.value[1],message='robot exec ended,release task is ' + str(local_store_tools.get_data("task_id")))
